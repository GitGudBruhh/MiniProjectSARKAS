...
if __name__ == "__main__":
    ...
    while(i<100):
        ...
        guess_no, comb = genetic_algorithm(secret_code, NUM_COLORS, CODE_LENGTH, POPULATION_SIZE, NUM_GENERATIONS, 0)
        l.append(guess_no)
        ...
        i+=1
    print('\n')
    print("Average no. guesses:",(Sum/(i+1)))
    print("SD of guesses:",(sum([((g-Sum/(i+1))**2)/(i+1) for g in l]))**(0.5))
    print("Average no. of combinations evaluated:",(total_comb/(i+1)))    
    print("SD of combinations eveluated:",((sum([((g-total_comb/(i+1))**2)/(i+1) for g in comb_eval_l])))**(0.5))
