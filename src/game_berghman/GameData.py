...
class GameData:
    ...
    def __init__(self, NUM_COLORS: int, POPULATION_SIZE: int, CODE_LENGTH: int, secret_code: list[str], NUM_GENERATIONS: int, MUTATION_RATE: float, PERMUTATION_RATE: float, INVERSION_RATE: float):
        # print(noColours)
        ...
        self.setPerRate(PERMUTATION_RATE)
        self.setInvRate(INVERSION_RATE)
    ...
    def setInvRate(self, INVERSION_RATE: float):
